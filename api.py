...
from yt_transcript.src.core.transcript import fetch_transcript_youtube_api, process_transcript
...
def process_video():
    ...
    transcript_data = fetch_transcript_youtube_api(video_id, api_key)
